...
module Page33
    def self.text    
    puts """
    You jam the turnstile gate with your crowbar and limp over to the escalator and stairs. The throng of angry zombies tries to push through the gate after you, but is unable to pass. They glare at you with frustrated moans and snarls.
There is no power to the escalator, so you take the stairs, climbing up to the subway’s main corridor. This is the wide concrete and tile entryway into the subway itself; and you can actually see the exit to your left, beyond a bank of narrow token-operated turnstiles. Unfortunately, a huge mass of zombies crowd the area – both in front of the turnstiles and on the other side, where the tunnel itself simply opens without walls to the outside. You stifle a gag, as the smell of blood and death is overpowering here. Looking at the floor of the main corridor, you shudder to see hundreds of ripped open and dismembered bodies lying in sticky footprint-tracked pools of maggot and fly infested blood. You force yourself to ignore the nauseating massacre and take in the more pertinent details of the scene.
...
puts """
        ...
        2. Try to sneak across to the transit authority door
        3. Run to the security door (and get the pistol)
        4. Try to sneak to the security door (and get the pistol)
	"
